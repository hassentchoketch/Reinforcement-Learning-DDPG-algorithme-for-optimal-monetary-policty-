...
This project attempts to replicate and verify the results and findings of the following paper [N Hinterlang,A Tanzer(2021) "Optimal monetary policyusing reinforcement learning",Discussion Paper,Deutsche Bundesbank No 51](https://d-nb.info/1248317343/34) using python .
